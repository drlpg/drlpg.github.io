...
window.WeatherIcons = {
    ...
    testWindMapping: function () {
        ...
        console.log('🚩 风向图标映射测试（普通风向用旗帜，特殊情况保持原图标）:');
        testWinds.forEach(wind => {
            const icon = this.getWindIcon(wind);
...
// 初始化确认 - v20250914
console.log('天气图标系统已加载 v20250914');
console.log('风向图标：普通风向使用旗帜🚩，特殊情况保持原图标');
